...
### Members: Aaron Clark, Jon Stillson, Dylan Cooper, Alex Chao

## Cooperation Plan

* What are the key strengths of each person on the team?
   * Aaron’s overall strength is in project management, and programming in general. Cooper is strong in doing UI and thinking about the overall user experience.  Jon's strengths are organization and working collaboratively Jon is also strong in presentations. Chao's is strong in execution of tasks and planning.
* How can you best utilize these strengths in the execution of your project?
   * Aaron will act as project coordinator and manage daily tasks and standup + keeping our board up to date and clean.  Cooper will have final say and contribute largely to the finished interface and UX of our app. Jon will use his planing to detrimine the architecture and presentation slides  Chao will also contribute the overall design. Chao will match up what we need to do with what tooling framework.
* In which professional competencies do you each want to develop greater strength?
   * Aaron would like to improve his teamwork and collaboration skills. Cooper also wants to improve his collaboration skills and improve on his tool proficiency as it relates to UI/UX. Chao will work on ambiguity by coming with a plan on tackling features and user stories with the team. Jon will work on collaboration an teamwork.
...
* What will be your group’s process to resolve conflict, when it arises? 
   * Discuss any issues individually and directly if possible. If needed, an issue can be escalated to the whole group. if no resolution can be achieved then we will bring in Rey.
* What will your team do if one person is taking over the project and not letting the other members contribute?
   * We will make them work more in pair program more to ensure the sharing of work load.
...
* How you will identify tasks, assign tasks, know when they are complete, and manage work in general?
   * We will also use Github-projects to help us keep track of any assignments we need to complete. We will use our daily standup to break out tasks and assign who will be working on what. We will also have an end of day meeting to sync up on all items that have been completed.
* What project management tool will be used?
   * We will be using GitHuB Projects for project management tool.
Git Process
* What components of your project will live on GitHub?
   * Everything except for environment variables and passwords to databases. Amplify Creds
